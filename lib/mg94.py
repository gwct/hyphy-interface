...
def generate(indir, tree_input, model_file, gt_opt, fit_opt, aln_id_delim, hyphy_path, outdir, logdir, outfile):
    ...
    for aln in aligns:
        ...
        hyphy_cmd = "hyphy " + model_file + " --alignment " + aligns[aln]['aln-file'] + " --tree " +  aligns[aln]['tree'] + " --lrt Yes --output " + cur_jsonfile;
